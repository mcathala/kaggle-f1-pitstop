...
OOF_OUT = DATA / "oof_xgb.parquet"
SUB_OUT = DATA / "submission_xgb.csv"
...
# XGBoost HPs — standard reasonable defaults for tabular binary AUC.
# eta 0.05, depth 8 mirrors CB-tuned-exp14's depth choice. enable_categorical
# uses XGBoost's native categorical-split algorithm.
XGB_PARAMS = {
    ...
    "reg_lambda": 5.0,
    "reg_alpha": 0.5,
    "max_cat_to_onehot": 4,    # one-hot small cats, otherwise use partitioning
    "nthread": -1,
    "verbosity": 1,
}
N_ROUNDS = 3000
