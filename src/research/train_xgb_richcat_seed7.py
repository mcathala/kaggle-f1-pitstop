...
OOF_OUT = DATA / "oof_xgb_richcat_seed7.parquet"
SUB_OUT = DATA / "submission_xgb_richcat_seed7.csv"
...
N_SPLITS = 5
# Multi-seed averaging requires identical folds across runs → fix CV_SEED at 42.
# Only MODEL_SEED varies between runs (cycle 14 uses 7 here; cycle 11 used 42-derived).
CV_SEED = 42
MODEL_SEED = 7
