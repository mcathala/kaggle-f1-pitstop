...
OOF_OUT = DATA / "oof_realmlp_view3_6seed.parquet"
SUB_OUT = DATA / "submission_realmlp_view3_6seed.csv"
...
def feature_engineering(df, fit, state):
    ...
    combo_names = []
    for cols in [("Race", "Compound"), ("Race", "Year"), ("Driver", "Race"), ("Compound", "Stint"), ("Driver", "Compound")]:
