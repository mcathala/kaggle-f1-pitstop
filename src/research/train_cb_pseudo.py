...
def main() -> None:
    ...
    print("Reading strong-blend labeler (data/submission_blend_pseudo6.csv)...")
    lab = pd.read_csv(DATA / "submission_blend_pseudo6.csv").sort_values(ID_COL).reset_index(drop=True)
